...
Download: [python.org](https://www.python.org "Python")
...
ambiente de desenvolvimento, também podemos enviar linhas de commandos que
serão interpretadas e executadas. 

Atualmente os interpretadores de comandos são commandos como `shell`.
...
Como identificar se estamos no shell do python?
 ...
 - A linha de commando usa <span style="background-color:white; color:black">`>>>`</span>
...
Por que tenho que abrir `(` e fechar `)` no comando exit?
